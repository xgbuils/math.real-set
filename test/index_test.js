...
var getIntervals = require('./get-intervals.js')
...
describe('RealSet', function () {
    ...
    describe('.isEmpty()', function () {
        it('returns true if is empty set', function () {
            var set = RealSet.parse('[2, 0) U (1, 1) U (10, 0)')
    ...
    describe('RealSet.union', function () {
        it('union of disjoint real sets', function () {
            var set1 = RealSet.parse('(0, 1] U [8, 9]')
            var set2 = RealSet.parse('(4, 5) U {7}')
        ...
        it('union of intersected real sets', function () {
            var set1 = RealSet.parse('[3, 5] U {7}')
            var set2 = RealSet.parse('[5, 6) U (6, 8)')
        ...
        it('union of empty real sets', function () {
            var set1 = RealSet.parse('(8, 8)')
            var set2 = RealSet.parse('(3, 0]')
    ...
    describe('.union()', function () {
        it('union method works in the same way that static union method', function () {
            var set1 = RealSet.parse('(4, 5) U [8, 9]')
            var set2 = RealSet.parse('{7} U [3, 5]')
            var set3 = RealSet.parse('(0, 1]')
